...
void TFbxImporter::GetAnimation(FbxNode* pNode,
							    FbxAnimStack* pAnimStack, FbxTime& time)
{
	...
	*/
	//FbxAnimEvaluator* pEval = m_pScene->GetAnimationEvaluator();
	//FbxAMatrix globalTransform = pEval->GetNodeGlobalTransform(pNode, time);
	//FbxAMatrix localTransform = pEval->GetNodeLocalTransform(pNode, time);
