...
{   
    ...
    if (pObject1->Create())
    {
        ...
        pObject1->m_pTexture = pTex;
        // pObject1->SetTexture(pTex);
        pObject1->m_pShader = I_Shader.Load(L"../../data/shader/Default.txt");        
        //TShader* pPShader = I_Shader.Load(L"../../data/shader/Default.txt","PS");
        // pObject1->SetPShader(pPShader);
        pObject1->CreateInputLayout();
        //pObject1->SetLayout(pObject1->m_pShader, 
          //                  g_VertexLayout[0]);
